...
console.log('Cerebras API:', process.env.CEREBRAS_API_KEY ? '✅ Active (gpt-oss-120b)' : 'ℹ️ Not configured (optional fallback)');
...
console.log('Z.ai API:', process.env.Z_AI_API_KEY ? '✅ Active (GLM-5-Flash fallback)' : 'ℹ️ Not configured (optional fallback)');
