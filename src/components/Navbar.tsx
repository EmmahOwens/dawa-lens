...
export function Navbar({ className }: NavbarProps) {
  return (
    <header
      className={cn(
        "h-16 flex items-center justify-between border-b border-white/10 px-8 bg-background/60 backdrop-blur-2xl backdrop-saturate-[1.8] sticky top-0 z-30 shadow-sm gpu-accel",
        className
      )}
    >
