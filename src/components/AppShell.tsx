  ...
  if (isMobile) {
    return (
      <div className="h-screen bg-background overflow-hidden flex flex-col overscroll-none">
        ...
        <div className="h-[env(safe-area-inset-top,20px)] bg-background/70 backdrop-blur-[10px] backdrop-saturate-[180%] sticky top-0 z-40 w-full gpu-accel" />
    ...
    <SidebarProvider>
      <div className="h-screen flex w-full bg-background overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-16 flex items-center justify-between border-b border-border/20 px-8 bg-background/70 backdrop-blur-[10px] backdrop-saturate-[180%] sticky top-0 z-30 shadow-sm gpu-accel">
