...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-3 left-0 right-0 z-50 mx-auto max-w-sm md:hidden px-4 pb-safe-bottom gpu-accel" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
      <div className="flex items-center justify-between rounded-[2rem] border border-border/20 bg-background/70 px-4 py-2.5 shadow-[0_8px_16px_rgba(0,0,0,0.2)] backdrop-blur-[10px] backdrop-saturate-[180%] relative">
        {/* Left Side Items */}
