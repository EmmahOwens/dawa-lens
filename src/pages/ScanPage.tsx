...
import {
  ...
  ARInstructionType,
} from "@/components/ui/ARInstruction";
      ...
      <div className="absolute top-0 left-0 right-0 z-50 pt-[env(safe-area-inset-top,2rem)] px-4 pb-4 bg-gradient-to-b from-black/80 to-transparent">
        <div className="flex items-center justify-between gap-4 max-w-lg mx-auto">
              ...
              {["pill", "text"].map((mode) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex-1 flex items-center justify-center gap-2 rounded-full transition-all duration-500 z-10 ${
                      active
          ...
          <button
            ...
            className={`flex items-center justify-center w-10 h-10 rounded-full backdrop-blur-md border transition-all ${
              flashlightOn
        ...
        <div className="flex items-center justify-between max-w-sm mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <label
              ...
              className="flex items-center justify-center w-14 h-14 rounded-full bg-white/10 backdrop-blur-2xl border border-white/10 text-white hover:bg-white/20 transition-all active:scale-90 cursor-pointer"
            >
              <Upload size={22} />
              <input
                type="file"
